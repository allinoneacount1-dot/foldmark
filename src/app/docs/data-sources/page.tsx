  ...
  return (
    <article>
      <DocTitle
        ...
        lede="What FOLDMARK reads, how fresh it is, how far it can be trusted, and what the product does when a source fails. Sources that are not wired are marked PLANNED and are never presented as live."
      />
            ...
            {SOURCES.map((s) => (
              <div key={s.name} className="bg-void p-4">
                <div className="flex flex-wrap items-baseline justify-between gap-3">
                  ...
                  <StateTag state={s.status === "LIVE" ? "OK" : "INDEXING"} label={s.status} />
                </div>
        ...
        <DocSection id="trust" title="Trust levels">
          ...
          <DocTable
            ...
            rows={[
              ...
              ["UNAVAILABLE", "Not measurable in this deployment. Withheld, never estimated.", "Price, liquidity, holders."],
            ]}
          />
        </DocSection>
        ...
        <DocSection id="provenance" title="Provenance">
          ...
          <DocTable
            ...
            rows={[
              ...
              ["Price", `No oracle wired to chain ${CHAIN.id}`, "UNAVAILABLE"],
              ["Liquidity, holders, markets", "No venue registry, no full-history replay", "UNAVAILABLE"],
            ]}
          />
        </DocSection>
        ...
        <DocSection id="failure" title="Failure behaviour">
          ...
          <List
            items={[
              ...
              "Storage unreachable → every dependent figure reads DATA UNAVAILABLE. No cached approximation is served in its place.",
